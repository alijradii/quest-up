...
export function LeaderboardCard({ entry }: LeaderboardCardProps) {
    ...
    const levelProgress = (user.completed_quests % 10) * 100;
                ...
                <div className="flex items-center gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-2 mb-1">
                                ...
                                {isCurrentUser && (
                                    <Badge
                                        variant="outline"
                                        className="text-xs px-2 py-0.5 text-primary border-primary/20"
                                    >
                                        You
                                    </Badge>
                                )}
                    ...
                    <div className="flex flex-col items-center gap-2 min-w-[80px]">
                        <div className="relative">
                            ...
                            <Badge className="absolute -bottom-1 left-1/2 -translate-x-1/2 bg-primary text-xs px-2">
                                Level
                            </Badge>
                        </div>
